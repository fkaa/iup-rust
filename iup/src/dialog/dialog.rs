...
use Element;
use callback::{CallbackReturn, IntoRust};
...
impl ::callback::DropDataCb for Dialog {}
...
impl_callback! {
    ...
    pub trait CopyDataCb where Self: Element {
        ...
        fn set_copydata_cb<F: Callback(Self, String) -> c_int>(&mut self, cb: F) -> Self;
...
impl_callback! {
    ...
    pub trait TrayClickCb where Self: Element {
        ...
        fn set_trayclick_cb<F: Callback(Self, MouseButton, MouseButtonState, bool) -> c_int>(&mut self, cb: F) -> Self;
