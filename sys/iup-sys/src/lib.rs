...
pub enum Ihandle {}
pub type Icallback = Option<extern fn(ih: *mut Ihandle) -> c_int>;
pub type Iparamcb = Option<extern fn (dialog: *mut Ihandle, param_index: c_int, user_data: *mut c_void) -> c_int>;
...
extern {
    ...
    pub fn IupFlatList(action: *const c_char) -> *mut Ihandle;
    ...
    pub fn IupFlatVal(_type: *const c_char) -> *mut Ihandle;
    ...
    pub fn IupPostMessage(argc: *mut Ihandle, ch: *const i8, i: i32, d: f64, p: *mut c_void);
