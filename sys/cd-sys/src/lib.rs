...
pub const CD_NAME: &'static str = "CD - A 2D Graphics Library";
pub const CD_DESCRIPTION: &'static str = "Vector Graphics Toolkit with Device Independent Output";
pub const CD_COPYRIGHT: &'static str = "Copyright (C) 1994-2019 Tecgraf, PUC-Rio";
pub const CD_VERSION: &'static str = "5.12"; /* bug fixes are reported only by IupVersion functions */
pub const CD_VERSION_NUMBER: c_int = 512000;
pub const CD_VERSION_DATE: &'static str = "2019/01/07"; /* does not include bug fix releases */

pub type cdCallback = Option<unsafe extern "C" fn(canvas: *mut cdCanvas, ...) -> c_int>;
pub type cdSizeCB = Option<unsafe extern "C" fn(canvas: *mut cdCanvas, w: c_int, h: c_int, w_mm: f64, h_mm: f64) -> c_int>;
pub enum cdContext {}
pub enum cdCanvas {}
pub enum cdState {}
pub enum cdImage {}
